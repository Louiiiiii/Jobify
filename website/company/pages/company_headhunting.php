...
require_once '../parts/company_filters.php';
...
$db = new DB();
$filter = $db->pdo->prepare( 'select concat_ws(" ",a.firstname, a.lastname ) employee, a.birthdate birthday, ad.street street, ad.number number, c.city city, p.postalcode postalcode, e.name education, u.user_id user
